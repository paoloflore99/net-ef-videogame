...
namespace net_ef_videogame
{
    public static class VideogameManager
    {
        ...
        public static void InserisciVideogame(string name,string overview, string descrizione ,int software_house_id)
        {
            Videogame NuovoGioco = new Videogame(name, overview, descrizione, software_house_id);
            using SqlConnection eseguitoConessione = new SqlConnection(DatabaseConesso);

            try
            {
                eseguitoConessione.Open();
                string query = "INSERT INTO videogames(name , overview , software_house_id) VALUES (@name , @overview  , @software_house_id)";
